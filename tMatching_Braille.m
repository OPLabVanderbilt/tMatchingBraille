...
for i = 1:trialCount
    ...
    if strcmp(trials.Item1{i}, '') % It's a break
        ...
        DrawFormattedText(expWindow, ['Trial ' num2str(trial) ': ' ...
            'participant is waiting for card ' num2str(trial) ...
            '.1\n\nItem 1: ' trials.Item1{i} '\nItem 2: ' ...
            trials.Item2{i}], 'center', 'center', black);
        Screen('Flip', expWindow);
        GetClicks;
        ...
        DrawFormattedText(expWindow, ['Trial ' num2str(trial) ': ' ...
            'participant is on card ' num2str(trial) '.1\n\nItem 1: ' ...
        ...
        DrawFormattedText(expWindow, ['Trial ' num2str(trial) ': ' ...
            'participant is on card ' num2str(trial) '.2\n\nItem 1: ' ...
            trials.Item1{i} '\nItem 2: ' trials.Item2{i}], 'center', ...
            'center', black);
        Screen('Flip', expWindow);
